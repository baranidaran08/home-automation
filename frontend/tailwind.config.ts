...
/**
 * Tailwind config wired for shadcn/ui — colors reference CSS variables defined
 * in `src/app/globals.css`, so light/dark theming is driven by the `.dark`
 * class toggled by next-themes.
 */
const config: Config = {
  darkMode: ['class'],
  content: [
